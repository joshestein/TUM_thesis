...
def get_transforms(
    augment: bool = True, percentage_slices: float = 1.0, sample_areas=("apex", "base", "mid")
) -> (Compose, Compose):
    ...
    train_transforms += [
        RemoveSlicesd(keys=keys, percentage_slices=percentage_slices, sample_areas=sample_areas),
